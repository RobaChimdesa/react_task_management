...
const BodyPage = () => {
  ...
  const learnmore = "https://www.coursera.org/articles/task-management";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center  mx-56">
      ...
      <div className="flex gap-4">
        <button
          onClick={() => navigate(Pages_Routes.sign_up)}
          className="bg-white text-purple-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition"
        >
          Get Started
        </button>
